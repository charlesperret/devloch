      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "Nous demandons uniquement les accès nécessaires aux fonctions prévues : gestion de campagnes, validation, reporting, attribution publicitaire et import de conversions hors ligne. Les conversions améliorées peuvent être utilisées pour mesurer les propres campagnes de devlo lorsque le consentement et la base légale le permettent ; Customer Match ou tout autre usage sensible nécessite une revue séparée de confidentialité et de conformité.",
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "We request only the access required for the intended functions: campaign management, validation, reporting, advertising attribution, and offline conversion import. Enhanced conversions may be used to measure devlo's own campaigns when consent and the legal basis allow it; Customer Match or any other sensitive user-data use requires a separate privacy and compliance review.",
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "Wir beantragen nur Zugriffe, die für Kampagnenmanagement, Validierung, Reporting, Werbeattribution und Offline-Conversion-Import erforderlich sind. Enhanced Conversions können zur Messung der eigenen Kampagnen von devlo genutzt werden, wenn Einwilligung und Rechtsgrundlage dies erlauben; Customer Match oder jede andere sensible Nutzerdatenverwendung erfordert eine separate Datenschutz- und Compliance-Prüfung.",
  ...
  nl: {
    privacy: {
      ...
      sections: [
        ...
        { heading: "5. Google Ads API en Google-gegevens", paragraphs: ["De Google Ads API-workflow van devlo wordt gebruikt om de eigen advertentieaccounts van devlo te beheren en te meten. Het is geen selfserviceplatform voor derden en verkoopt geen toegang tot de Google Ads API door.", "We vragen alleen toegang die nodig is voor campagnebeheer, validatie, rapportage, advertentieattributie en offline conversie-import. Enhanced conversions kunnen worden gebruikt om devlo's eigen campagnes te meten wanneer toestemming en de wettelijke basis dit toelaten; Customer Match of elk ander gevoelig gebruik van gebruikersgegevens vereist een aparte privacy- en compliancebeoordeling.", "Wanneer wij gegevens verwerken die via Google API's zijn ontvangen, voldoen wij aan de Google API Services User Data Policy, inclusief de Limited Use-vereisten: https://developers.google.com/terms/api-services-user-data-policy. Deze gegevens worden alleen gebruikt om toegestane functies te leveren of te verbeteren, de dienst te beveiligen, de wet na te leven en toepasselijk Google-beleid te volgen."] },

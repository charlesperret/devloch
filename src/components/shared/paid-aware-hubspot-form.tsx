    ...
    return (
      <form className="space-y-4" onSubmit={submitNativeForm} onFocusCapture={trackFormStart}>
        ...
        <button
          ...
          className="inline-flex h-12 items-center justify-center rounded-md bg-[#f47b5f] px-6 text-sm font-extrabold text-white transition hover:bg-[#e3654d] disabled:cursor-not-allowed disabled:opacity-70"
        >
